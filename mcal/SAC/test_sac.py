...
from syscon_test_amcl_world_LAH2 import StageWorld
...
parser.add_argument('--num_steps', type=int, default=11, metavar='N',
...
def run(comm, env, agent, policy_path, args):
    ...
    for i_episode in range(args.num_steps):
        ...
        while not done and not rospy.is_shutdown():    
            ...
            compute_end_time = rospy.Time.now()

            compute_time = compute_end_time - compute_start_time

            compute_time_sec = compute_end_time.secs - compute_start_time.secs

            compute_time_nsec = compute_end_time.nsecs - compute_start_time.nsecs

            logger_time.info('Env: %d, Episode: %d, time :%d.%d, time2 :%d.%d, start_time: %d.%d, end_time: %d.%d',  env.index, i_episode+1, compute_time_sec, compute_time_nsec, compute_time.secs, compute_time.nsecs, compute_start_time.secs, compute_start_time.nsecs, compute_end_time.secs, compute_end_time.nsecs )
...
if __name__ == '__main__':
    ...
    task_name = 'REAL_S_R5_dc_sac_full'
    ...
    if rank == 0:
        ...
        #file_policy = policy_path + '/20201027_policy_epi_1400.pth' 
        ...
        # static obstacle 20201021 policy
        #file_policy = policy_path + '/20201022_policy_epi_4500.pth' 
        #file_critic_1 = policy_path + '/20201022_critic_1_epi_4500.pth'
        #file_critic_2 = policy_path + '/20201022_critic_2_epi_4500.pth'

        # gazebo train statoc obstacle 20201023 policy
