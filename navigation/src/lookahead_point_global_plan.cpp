...
class LookAhead
{
    ...
    private:
	    ...
	    std::string odom_frame, odom_topic, plan_topic, goal_topic, amcl_topic, lah_point_topic, lah_marker_topic, lah_marker_pose_topic;
...
LookAhead::LookAhead()
{
    ...
    //Show info
    odom_topic = "odom";
    plan_topic = "move_base/TrajectoryPlannerROS/global_plan";
        ...
        for(int i =0; i< map_path.poses.size(); i++)
        {
            ...
            try
            {
                ...
                if(_isWayPtAwayFromLfwDist)
                {
                    ...
                    lookAhead_Pose.header.frame_id = "odom";
