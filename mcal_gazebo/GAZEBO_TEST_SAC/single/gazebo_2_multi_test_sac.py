...
from model.utils import soft_update, hard_update, get_group_terminal
...
from syscon_gazebo_2_multi_test_amcl_world_LAH2 import StageWorld
...
def run(comm, env, agent, policy_path, args):
    ...
    for i_episode in range(args.num_steps):
        ...
        env.set_gazebo_pose(-8.0, 0.0, 0.0)
        env.set_rviz_pose(-8.0, 0.0, 0.0)        
        env.send_goal_point()
        ...
        while not done and not rospy.is_shutdown():    
            ...
            #group_terminal = 
            #group_terminal = get_group_terminal(done_list, env.index)
...
if __name__ == '__main__':
    ...
    task_name = 'SIMUL_MULTI_2_2_201201'
