...
class StageWorld():
    ...
    def path_callback(self, Path_msg):
        ...
        if self.waypoint_gen_flag == 1:
            ...
            sub_goal = Pose()
            sub_goal.position.x = self.goal_point[0]
            sub_goal.position.y = self.goal_point[1]
            sub_goal.position.z = 0
            sub_goal.orientation.x = 0
            sub_goal.orientation.y = 0
            sub_goal.orientation.z = 0
            sub_goal.orientation.w = 0
            self.waypoint_pose.publish(sub_goal)
